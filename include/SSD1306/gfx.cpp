...
{
  BeagleBone::SSD1306 drv(BeagleBone::gpio::P8(44),  // CLK
			  BeagleBone::gpio::P8(46),  // DIN
			  BeagleBone::gpio::P8(42),  // D/C
			  NULL,  // CS
			  BeagleBone::gpio::P8(40)); // RST

  printf("Starting Test...\n");

  drv.begin();

  BeagleBone::gfx fx(drv);
  ...
  fx.drawLine(0,0, X,Y, BeagleBone::RGB::black);
  fx.drawLine(X,0, 0,Y, BeagleBone::RGB::black);
  usleep(500000);
  fx.clearScreen();

  fx.fillScreen(BeagleBone::RGB::black);
  usleep(500000);
  fx.fillScreen(BeagleBone::RGB::white);
  usleep(500000);

  fx.drawCircle(X/2, Y/2, 24, BeagleBone::RGB::black);
  fx.drawCircle(X/2, Y/2, 18, BeagleBone::RGB::black);
  fx.drawCircle(X/2, Y/2, 12, BeagleBone::RGB::black);
  fx.drawCircle(X/2, Y/2,  6, BeagleBone::RGB::black);
  usleep(500000);

  fx.clearScreen();
  fx.fillCircle(X/2, Y/2, 24, BeagleBone::RGB::black);
  fx.fillCircle(X/2, Y/2, 18, BeagleBone::RGB::white);
  fx.fillCircle(X/2, Y/2, 12, BeagleBone::RGB::black);
  fx.fillCircle(X/2, Y/2,  6, BeagleBone::RGB::white);
  usleep(500000);

  fx.setAutoRefresh(0);
  fx.clearScreen();
  fx.drawRoundRect( 0,0,  X,   Y,    6, BeagleBone::RGB::black);
  fx.drawRoundRect( 6,6,  X-12,Y-12, 6, BeagleBone::RGB::black);
  fx.drawRoundRect(12,12, X-24,Y-24, 6, BeagleBone::RGB::black);
  fx.refreshScreen();
  usleep(500000);

  fx.fillRoundRect( 0,0,  X,   Y,    6, BeagleBone::RGB::black);
  fx.fillRoundRect( 6,6,  X-12,Y-12, 6, BeagleBone::RGB::white);
  fx.fillRoundRect(12,12, X-24,Y-24, 6, BeagleBone::RGB::black);
  fx.refreshScreen();
  usleep(500000);

  fx.setAutoRefresh(1);
  fx.clearScreen();
  fx.drawTriangle( 42,2,  63,44, 21,44, BeagleBone::RGB::black);
  usleep(500000);

  fx.fillTriangle( 42,2,  63,44, 21,44, BeagleBone::RGB::black);
  usleep(500000);

  fx.clearScreen();
  fx.setCursor(0, 0);
  fx.setTextColor(BeagleBone::RGB::black, BeagleBone::RGB::white);
  fx.setTextSize(1);
  fx.setTextWrap(1);
  fx.write('A');
  fx.write('B');
  ...
  fx.setAutoRefresh(1);
  fx.write('\n');
  fx.setTextColor(BeagleBone::RGB::white, BeagleBone::RGB::black);
  fx.setTextSize(2);
  fx.setTextWrap(1);
  fx.write("ABCDEFG");
  usleep(500000);
  ...
  fx.setCursor(0, 0);
  fx.setTextSize(1);
  fx.setTextColor(BeagleBone::RGB::white);
  fx.fillScreen(BeagleBone::RGB::black);
